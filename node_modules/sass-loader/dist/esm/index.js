...
import { errorFactory, getCompileFn, getModernWebpackImporter, getSassImplementation, getSassOptions, normalizeSourceMap, removeBOM } from "./utils.js";
...
async function loader(content) {
  ...
  const {
    css,
    map: cssMap
  } = removeBOM(result.css.toString(), map);
